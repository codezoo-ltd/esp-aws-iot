...
#define GPIO_OUTPUT_RED				(gpio_num_t)GPIO_NUM_12
#define GPIO_OUTPUT_RED_PIN_SEL		(1ULL<<GPIO_OUTPUT_RED)
#define GPIO_OUTPUT_GREEN			(gpio_num_t)GPIO_NUM_14
#define GPIO_OUTPUT_GREEN_PIN_SEL	(1ULL<<GPIO_OUTPUT_GREEN)
#define GPIO_OUTPUT_BLUE			(gpio_num_t)GPIO_NUM_15
#define GPIO_OUTPUT_BLUE_PIN_SEL	(1ULL<<GPIO_OUTPUT_BLUE)
...
static void config_gpio(void)
{
	...
	io_conf.pin_bit_mask = (GPIO_OUTPUT_WAKEUP_PIN_SEL | GPIO_OUTPUT_RESET_PIN_SEL | 
			GPIO_OUTPUT_PWRKEY_PIN_SEL | GPIO_OUTPUT_EXTANT_PIN_SEL | GPIO_OUTPUT_RED_PIN_SEL |
			GPIO_OUTPUT_GREEN_PIN_SEL |	GPIO_OUTPUT_BLUE_PIN_SEL );
...
static void DHT_task(void *pvParameter)
{
    ...
    ESP_LOGI(TAG2, "Starting DHT Task\n\n");

    while (1) 
    {
        //ESP_LOGI(TAG2, "=== Reading DHT ===\n");
        int ret = readDHT();
